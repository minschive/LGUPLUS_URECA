...
// 말처럼 움직이는 횟수 K 제한
// 어느 특정 좌표에서 상하좌우 또는 말처럼 움직이는 2가지를 고려
...
public class BJ_말이되고픈원숭이_1600 {
	...
	// visit 처리는 동일 좌표 방문 시, 이후 동일한 상황 반복되기 때문, 이 문제는 같은 좌표라 하더라도 K 값이 얼마냐에 따라 이후 상황이 달라질 수 있다.
	// 3차원 배열 <= [][] + K
