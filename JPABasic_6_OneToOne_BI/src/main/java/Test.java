...
//        em.persist(passport);
        ...
        // 7-1
//        em.persist(person);
        // org.hibernate.TransientObjectException: persistent instance references an unsaved transient instance of 'entity.Passport'

        // 7-2
//        em.persist(passport);
        // org.hibernate.TransientObjectException: persistent instance references an unsaved transient instance of 'entity.Person'
        // 양방향 일 경우, passport 만 persist 하지 못한다. ( 단방향일 경우, 가능)

        // 7-3
        // Passport 의 @OneToOne 에 cascade = CascadeType.PERSIST 추가
        em.persist(passport);
        // org.hibernate.TransientObjectException: persistent instance references an unsaved transient instance of 'entity.Person'
        // 양방향 일 경우, passport 만 persist 하지 못한다. ( 단방향일 경우, 가능)
