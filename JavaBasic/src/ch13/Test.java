...
//		Car car = carAgency.rent();
		...
		// 아래 방법이 인터페이스를 사용할 경우 더 나은 코드
		// Rentable 에 있는 메소드를 사용하고 싶어서 Rentable<P>
...
//		System.out.println(compare("Hello", "World")); // err
	}
	...
	// T 는 모든 타입의 객체가 아닌 Number 를 포함한 하위 클래스로 제한
