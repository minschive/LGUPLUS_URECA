...
public class Test2 {
	...
	public static void main(String[] args) {
		// String 객체의 비교
		{
			...
			System.out.println(str2.equals(str4)); // heap 위치와 상관없이 문자열 내용 비교
...
//			
//			// charAt()
//			System.out.println(str.charAt(0)); // 범위를 벗어나면 StringIOBE 발생
//			
//			// replace()
//			System.out.println(str.replace("He", "AA")); // 새로운 문자열 return
